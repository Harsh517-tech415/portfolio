...
const themeActions = createSlice({
  ...
  reducers: {
    ...
    scrollToWorkExperence(state, action) {
      const workExperenceElement = window.document.getElementById("work-experence");
      workExperenceElement.scrollIntoView({
        behavior: "smooth",
        block: "start",
        inline: "start",
      });
...
export const { scrollToWorkExperence,toggleMode, scrollToAbout, scrollToProject, scrollToContact } =
